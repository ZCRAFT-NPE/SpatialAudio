package me.zcraft.mods.spatialaudio.config.BlueTapePack.mixin;
...
public abstract class NestedListSaveContentMixin extends AbstractListListEntry {
    ...
    public NestedListSaveContentMixin(Component fieldName, List value, boolean defaultExpanded, Supplier tooltipSupplier, Consumer saveConsumer, Supplier defaultValue, Component resetButtonKey, boolean requiresRestart, boolean deleteButtonEnabled, boolean insertInFront, BiFunction createNewCell) {
